...
- **UI**
  - 페이지 : 메인페이지 반응형, 마이페이지 마크업 및 스타일링, 에러페이지, 러닝페이지 스타일링
  - 공통 컴포넌트 : 반응형 헤더
- ## **기능**
...
| 마이페이지                                      |
| -------------------------------------------- |
| ![mypage](../whathappen/src/assets/homer.jpg) |
<br>
...
| 복습노트                                       |
| -------------------------------------------- |
| ![review](../whathappen/src/assets/homer.jpg) |
...
| 퀴즈페이지                                      |
| -------------------------------------------- |
| ![quizpage](../whathappen/src/assets/homer.jpg) |
...
| 학습완료페이지                                      |
| -------------------------------------------- |
| ![studyfinish](../whathappen/src/assets/homer.jpg) |
