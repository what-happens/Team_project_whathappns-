...
const dummyQuiz = [
  {
    stage: 1,
    question:
      "<h1>명작 영화 소개</h1>|=<h2 problem_id='1' incorrect_answers='h1,span,div'>Psycho(1960) - 스릴러</h2>=|<img src='#' alt='싸이코 포스터'/>|=<p problem_id='2' incorrect_answers='a,header,meta'>앨프리드 히치콕의 대표작 중 하나로, 로버트 블록이 쓴 동명 소설을 바탕으로 만든 영화.</p>=|<a href='#'>출처: 네이버 영화</a>",
  },
];
...
export default function Exercise() {
  ...
  useEffect(() => {
    const editorFiles = paresProblem(dummyQuiz[0].question);
